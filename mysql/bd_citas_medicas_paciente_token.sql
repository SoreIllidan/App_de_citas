...
--
-- Table structure for table `paciente_token`
--

DROP TABLE IF EXISTS `paciente_token`;
...
--
-- Dumping data for table `paciente_token`
--

LOCK TABLES `paciente_token` WRITE;
/*!40000 ALTER TABLE `paciente_token` DISABLE KEYS */;
/*!40000 ALTER TABLE `paciente_token` ENABLE KEYS */;
UNLOCK TABLES;
